...
def test_comprehensive_config():
    ...
    try:
        ...
        print(f"  Company aliases: {len(config['extraction'].get('company_aliases', []))}")
...
def test_individual_components():
    ...
    try:
        # Test config loading
        sys.path.insert(0, str(Path(__file__).parent / 'packages' / 'corpus-extractors' / 'configs'))
...
if __name__ == "__main__":
    success1 = test_comprehensive_config()
