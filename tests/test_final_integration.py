...
def test_full_integration():
    ...
    try:
        ...
        from corpus_extractors.attribution import get_nlp
        ...
        from corpus_extractors.attribution import Attributor
        ...
        test_context = "Apple CEO Tim Cook stated that the company will focus on privacy."
        doc = attributor.nlp(test_context)

        custom_entities = [ent for ent in doc.ents if ent.label_ in ['PERSON', 'ORG', 'TITLE']]
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("Run: python -m corpus_extractors.cli.extract quotes --input data/courtlistener_normalized.jsonl --output quotes.jsonl")
    else:
