...
class TestCaseIdParsing:
    ...
    def test_normalize_case_ids_with_missing(self):
        ...
        records = [
            ...
            {
                "doc_id": "1:23-cv-00475_dcd_entry_456",
                "case_id": "1:23-cv-00475",
                "value": 200,
            },
        ]
...
class TestComputeCaseValue:
    ...
    def test_acceptance_1_stipulated_judgment_wins(self):
        ...
        cash_amounts = [{"value": 10000, "feature_votes": 2, "doc_id": "doc3"}]
    ...
    def test_acceptance_4_settlement_ignored(self):
        ...
        """
        outcomes = [{"outcome_type": "settlement", "amount": 50000, "doc_id": "doc1"}]
        cash_amounts = [{"value": 1000, "feature_votes": 0, "doc_id": "doc2"}]
...
class TestAssignCaseValues:
    ...
    def test_acceptance_5_row_count_preservation(self):
        ...
        outcomes = [
            {
                "doc_id": "case1_doc1",
                "outcome_type": "stipulated_judgment",
                "amount": 100,
            }
        ]
        cash_amounts = []
    ...
    def test_output_schema(self):
        ...
        quotes = [{"doc_id": "case1_doc1", "text": "Quote 1", "speaker": "Speaker A"}]
        outcomes = []
        cash_amounts = []
...
class TestEdgeCases:
    ...
    def test_unparseable_case_id_results_in_na(self):
        ...
        quotes = [{"doc_id": "", "text": "Quote 1", "speaker": "A"}]
        outcomes = []
        cash_amounts = []
    ...
    def test_mixed_outcome_types_only_preferred_used(self):
        ...
        quotes = [{"doc_id": "case1_doc1", "text": "Quote 1", "speaker": "A"}]
        outcomes = [
        ...
        enriched = assign_case_values(
            quotes, outcomes, cash_amounts, "stipulated_judgment"
        )
