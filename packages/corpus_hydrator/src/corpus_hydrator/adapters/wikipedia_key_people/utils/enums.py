...
class IndexType(Enum):
    ...
    def display_name(self) -> str:
        ...
        names = {
            IndexType.DOW: "Dow Jones Industrial Average",
            IndexType.SP500: "S&P 500",
            IndexType.NASDAQ100: "NASDAQ-100",
        }
        return names[self]
...
class URLValidator:
    ...
    def is_valid_wikipedia_url(url: str) -> bool:
        ...
        return (
            ...
            or url.startswith("http://en.wikipedia.org/wiki/")
    ...
    def is_valid_wikidata_url(url: str) -> bool:
        ...
        return url.startswith("https://www.wikidata.org/wiki/") or url.startswith(
