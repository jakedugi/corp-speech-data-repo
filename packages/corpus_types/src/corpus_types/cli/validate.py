...
This CLI provides commands for validating JSONL files against corpus_types schemas
...
app = typer.Typer(no_args_is_help=True, help="corpus_types validation CLI")
console = Console()
...
def validate_jsonl(
    ...
    """
    Validate JSONL file against a corpus_types schema.
...
def validate_parquet(
    ...
    """
    Validate Parquet file against a corpus_types schema.
...
def generate_schemas(
    ...
    """
    Generate JSON Schema files for all corpus_types models.
...
def list_models() -> None:
    ...
    console.print("[bold]Available corpus_types models:[/bold]")
    descriptions = {
...
def callback():
    ...
    Use this CLI to validate data files against corpus_types schemas,
