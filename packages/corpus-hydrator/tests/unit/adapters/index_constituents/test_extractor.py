...
class TestIndexExtractionUseCase:
    ...
    def test_usecase_success(self, usecase, mock_provider, mock_parser):
        ...
        # Execute use case
        with patch('corpus_hydrator.adapters.index_constituents.normalize_rows') as mock_normalize:
    ...
    def test_usecase_provider_failure(self, usecase, mock_provider):
        ...
        from corpus_hydrator.adapters.index_constituents.providers.base import ProviderError

        mock_provider.fetch_raw.side_effect = ProviderError("mock", "sp500", "Network error")
