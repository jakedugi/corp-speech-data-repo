...
class TestWikipediaKeyPeopleNormalizer:
    ...
    def test_normalize_title_complex(self):
        ...
        result = self.normalizer.normalize_title("Executive Vice President, Global Sales")
    ...
    def test_title_normalization_comprehensive(self):
        ...
        for input_title, expected in test_cases:
            ...
            assert result == expected, f"Failed to normalize '{input_title}' to '{expected}', got '{result}'"
