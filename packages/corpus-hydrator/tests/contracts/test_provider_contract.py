...
class TestProviderContracts:
    ...
    @pytest.mark.parametrize("index_key", ["sp500", "dow", "nasdaq100"])
    def test_deterministic_output_contract(self, wikipedia_provider, html_parser, index_key):
    ...
    def test_symbol_uniqueness_contract(self, wikipedia_provider, html_parser):
        ...
        for index_key in ["sp500", "dow", "nasdaq100"]:
            ...
            if result.success:
                ...
                assert len(symbols) == len(unique_symbols), f"Duplicate symbols found in {index_key}"
    ...
    def test_data_completeness_contract(self, wikipedia_provider, html_parser):
        ...
        for index_key, min_count in min_counts.items():
            ...
            if result.success:
                ...
                assert result.total_constituents >= min_count, \
                ...
                companies_with_industry = sum(1 for c in result.constituents if c.industry)
                ...
                assert sector_completeness >= expected_sector_pct, \
