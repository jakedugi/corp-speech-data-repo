...
def process(
    input_dir: Path = typer.Option(
        ...,
        "--input",
        help="Input CourtListener directory (e.g., CourtListener/)"
    ),
    ...
    include_entries: bool = typer.Option(
        True,
        "--entries/--no-entries",
        help="Include entries (docket entries)"
    ),
    include_opinions: bool = typer.Option(
        True,
        "--opinions/--no-opinions",
        help="Include opinions"
    ),
...
def list_cases(
    input_dir: Path = typer.Option(
        ...,
        "--input",
        help="Input CourtListener directory"
    ),
):
    """
