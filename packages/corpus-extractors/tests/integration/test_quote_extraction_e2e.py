...
def normalized_docs() -> List[Dict[str, Any]]:
    ...
    fixture_path = Path(__file__).parent.parent.parent / "fixtures" / "normalized_sample.jsonl"
    docs = []
...
class TestQuoteExtractionE2E:
    ...
    def test_pipeline_runs_on_real_data(self, extractor: QuoteExtractor, normalized_docs: List[Dict[str, Any]]):
    ...
    def test_extracted_quotes_have_required_fields(self, extractor: QuoteExtractor, normalized_docs: List[Dict[str, Any]]):
    ...
    def test_quotes_have_valid_speakers(self, extractor: QuoteExtractor, normalized_docs: List[Dict[str, Any]]):
    ...
    def test_quotes_have_similarity_scores(self, extractor: QuoteExtractor, normalized_docs: List[Dict[str, Any]]):
    ...
    def test_quote_serialization(self, extractor: QuoteExtractor, normalized_docs: List[Dict[str, Any]]):
    ...
    def test_extraction_with_doc_id(self, extractor: QuoteExtractor, normalized_docs: List[Dict[str, Any]]):
